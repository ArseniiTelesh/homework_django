...
class BlogPost(models.Model):
    slug = models.CharField(max_length=150, verbose_name='slug (читаемый URL)', **NULLABLE)
    title = models.CharField(max_length=200, verbose_name='Заголовок')
    body = models.TextField(verbose_name='Текст записи')
    preview = models.ImageField(upload_to='BlogPost_photo/', **NULLABLE, verbose_name='Фото')
